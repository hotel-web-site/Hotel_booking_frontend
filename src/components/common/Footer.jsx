                    ...
                    <div className="inner">
                        ...
                        <div className="follow-us">
                            ...
                            <div className="follow-icons">
                                ...
                                target="_blank"
                                className="follow-link" aria-label="Facebook">
                                    <img
                                ...
                                <a href="https://x.com" 
                                target="_blank"
                                className="follow-link" aria-label="Twitter">
                                    <img
                                ...
                                target="_blank"
                                className="follow-link" aria-label="YouTube">
                                    <img
                                ...
                                target="_blank"
                                className="follow-link" aria-label="Instagram">
                                    <img
